...
class SA_module(nn.Module):
    def __init__(self, in_channel, out_channel, k=4, knn='xyz', bn=False):
...
class SADGCNN(nn.Module):
    def __init__(self, num_class, k1=16, k2=4, bn=False):
        ...
        self.edgeconv1_s = GA_Edgeconv(3*2, 32, k=k1, bn=bn)
        self.edgeconv2 = GA_Edgeconv(32*2, 128, k=k1, bn=bn)
        self.edgeconv2_s = GA_Edgeconv(32*2, 128, k=k1, bn=bn)
        self.sa1 = SA_module(32*2, 32, k=k2, knn='fea', bn=bn)
        self.sa2 = SA_module(128*2, 256, k=k2, knn='fea', bn=bn)
    ...
    def forward(self, xyz, xyz_s):
        ...
        fea1_s = self.edgeconv1_s(xyz_s) #(B, 32, N)
