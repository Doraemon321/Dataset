...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("cube_select", &cube_select);
  m.def("cube_select_two", &cube_select_two);
  m.def("cube_select_four", &cube_select_four);
  m.def("multi_directional_knn", &multi_directional_knn);
}
